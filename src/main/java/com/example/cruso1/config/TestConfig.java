...
public class TestConfig implements CommandLineRunner {
	...
	*/
	...
	public void run(String... args) throws Exception {
		...
		Cliente c1 = new Cliente(null, "nome", "telefone", "senha");
		Cliente c2 = new Cliente(null, "1nome", "1telefone", "1senha");
		Cliente c3 = new Cliente(null, "2nome", "2telefone", "2senha");
		clienteRepository.saveAll(Arrays.asList(c1,c2,c3));
		
		Produto pr1 = new Produto(null, "2nome", "2preco", 2);
		Produto pr2 = new Produto(null, "3nome", "3preco", 2);
		produtoRepository.saveAll(Arrays.asList(pr1,pr2));
